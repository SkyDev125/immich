...
/**
 * Splits an arbitrary edit rotation into the nearest quarter turn and a residual straighten angle.
 */
...
export const getEffectiveStraightenRotation = (angle: number, edits: AssetEditActionItem[] = []) => {
  ...
  // A single mirror conjugates rotation by negation; two mirrors preserve the original handedness.
...
/**
 * Maps a crop from the unrotated image coordinate system to the rotated canvas rectangle used by sharp.extract().
 */
